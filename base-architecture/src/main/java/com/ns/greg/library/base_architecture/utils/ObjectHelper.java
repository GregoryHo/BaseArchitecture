...
public class ObjectHelper {
  ...
  /**
   * Verifies if the object is null and returns true or false
   *
   * @param object the object of verify
   * @return true is null or false
   */
  ...
  @Target({ METHOD, TYPE }) @Retention(CLASS) @interface CanIgnoreReturnValue {
  }
